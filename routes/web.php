...
Route::get('/edit-product/{id}', [ForecastController::class, "edit"])->name("edit.product");
Route::put('/update-product/{id}', [ForecastController::class, "update"])->name("update.product");
